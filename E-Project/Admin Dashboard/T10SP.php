                    ...
                    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll mb-5">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $FetchCategory = mysqli_query($Con,"select product_name, sum(product_price) as product_price
                                from orders
                                ...
                                <tr>
                                    ...
                                    <td><b><?php echo $data['product_name'] ?></b></td>
                                    <td><b><?php echo $data['product_price'] ?></b></td>
