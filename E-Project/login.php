              ...
              <div class="col-12">
                ...
                <form action="bw.php" method="post" class="tm-login-form">
                  ...
                  <div class="form-group">
                    ...
                    <input name="mail" type="text" class="form-control validate" id="username" value="" required />
                  ...
                  <div class="form-group mt-3">
                    ...
                    <input name="pass" type="password" class="form-control validate" id="password" value="" required />

                  </div>

                  <div class="form-group mt-4">

                    <button type="submit" name="SI" class="btn btn-primary btn-block text-uppercase">
                      Login
                    </button>
